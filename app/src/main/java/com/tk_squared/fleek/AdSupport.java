...
class AdSupport implements InterstitialAdListener {
    ...
    public void showInterstitial(){
        if(interstitial.isInterstitialReady()){
            Log.i("SOMA AdSupport", "Showing interstitial");
            interstitial.show();
        } else {
            Log.i("SOMA AdSupport", "Interstitial not ready");
        }
    }
    ...
    public void onReadyToShow(){
        Log.i("SOMA AdSupport", "Interstitial ready to show");
    }
    ...
    public void onFailedToLoadAd(){
        Log.i("SOMA AdSupport", "Interstitial failed to load");
        interBannerLoad();
    }
